...
> AWeber Forms by MailMunch allows you to painlessly add AWeber sign up forms to your WordPress site. The form captures the lead and sends it to specific AWeber lists automatically. You can set it to no op-in, opt-in, or double opt-in. You can add forms to posts, pages or sidebar, and also open it as a popup or top bar. Simply sign up and connect your AWeber account into the plugin admin settings and it will pull in all your AWeber lists. From there you can choose the lists you want to make forms for.
...
* Beautiful templates for your AWeber newsletter sign-up form
* Complete Integration of AWeber into WordPress
* Easily import AWeber forms from an active AWeber account
* Monitor AWeber account activity
...
= Version 2.8+ =
1. Unzip our archive and upload the entire `aweber-mailmunch` directory to your `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Look for "AWeber" in the WordPress admin menu and click it
4. Sign up and create your first optin form
5. Choose the optin form type: Popover, Embedded or Top Bar
6. Connect AWeber and choose a list
...
= Do I need to have lists already set up in AWeber? =
Yes, you have to have at least 1 list set up in AWeber. 

= What do I do first? =
The first step is to activate the plugin and sign up. Then we will guide you through the process of connecting your AWeber account and choosing the list. This is done on the WordPress admin "AWeber" menu page.

= Do I need AWeber's API Key? =
You don't have to worry about that. We will guide you through the process.

= How do I add my AWeber lists? =
After you connect your AWeber account, the plugin will fetch all of your AWeber list information and load it into the plugin admin. You can simply choose the lists you want to make forms for.
...
Our AWeber email newsletter list builder helps WordPress users build their audiences online.

Why people use AWeber

* AWeber has free plans
* AWeber automatically integrates with our plugin
* AWeber easily sends newsletters
* AWeber handles lists of all sizes
* AWeber can send automated drip campaigns (scheduled emails)
* AWeber has better list management
* AWeber has great error messaging

== Screenshots ==

1. This is the AWeber optin form designer by MailMunch where you can customize your optin form
